...
function multiplier (multiplierNum) {
...
let multiplyWithBind = (number, multiplier) => {
  return multiplier * number
}

let duplicateWithBind = multiplyWithBind.bind(this, 2);
console.log(duplicateWithBind(10));

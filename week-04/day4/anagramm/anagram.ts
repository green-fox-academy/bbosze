...
export function pseudoAnagram(word1: string, word2: string): boolean {
...
export function trueAnagram (word1: string, word2: string): boolean {
...
console.log(realAnagram('elvis', 'lives'));
